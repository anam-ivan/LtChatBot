...
data class BasicDetails(
  ...
  @SerializedName("date_diagnosis") var dateDiagnosis: String? = null,
  @SerializedName("department") var department: String? = null,
  @SerializedName("department_name") var departmentName: String? = null,
  ...
  @SerializedName("last_fu_date") var lastFuDate: String? = null,
  ...
  @SerializedName("smoking") var smoking: String? = null,
  @SerializedName("specialization") var specialization: String? = null,
  @SerializedName("state") var state: String? = null,
  @SerializedName("status") var status: String? = null,
  @SerializedName("status_dead") var statusDead: Boolean? = null,
